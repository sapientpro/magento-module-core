...
class AddIsAllowPosDiscountAttribute implements DataPatchInterface, PatchRevertableInterface
{
    public const ATTRIBUTE_CODE = 'is_allow_pos_discount';
    ...
    /**
     * AddIsAllowPosDiscountAttribute constructor.
     *
